                ...
                cartItems.map((item, index) => (
                    <div className="grid grid-cols-3 gap-4 items-center" key={index}>
                        <div className="flex items-center gap-3">
                            <img src={item.image} className="w-12 h-12 object-cover rounded-xl shadow-md border border-gray-300"/>
                            <div className="flex flex-col flex-start">
                                <p className="text-black text-lg font-semibold">{item.name}</p>
                                <p className="text-xs text-orange-700 leading-relaxed font-semibold"><span className="text-xs text-gray-700 font-semibold">Category: </span>{item.category}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-around">
                            <p className="text-lg font-bold text-green-600 ml-16">{item.price}</p>
